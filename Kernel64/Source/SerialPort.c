/* filename          /Kernel64/Source/SerialPort.c
 * date              2018.12.10
 * last edit date    2018.12.10
 * author            NO.00[UNKNOWN]
 * brief             source code for serial port driver
*/
...
/**
 *  function name : kInitializeSerialPort
 *  Parameters    : void
 *  return value  : void
...
/**
 *  function name : kIsSerialTransmitterBufferEmpty
 *  Parameters    : void
 *  return value  : BOOL
 *  brief         : check FIFO is empty
 */
...
/**
 *  function name : kSendSerialData
 *  Parameters    : pbBuffer(BYTE*)
 *                  iSize(int)
 *  return value  : void
 *  brief         : send data
 */
...
/**
 *  function name : kIsSerialReceiveBufferFull
 *  Parameters    : void
 *  return value  : BOOL
 *  brief         : check received buffer
 */
...
/**
 *  function name : kReceiveSerialData
 *  Parameters    : pbBuffer(BYTE*)
 *                  iSize(int)
 *  return value  : BOOL
