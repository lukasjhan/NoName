/* filename          /Kernel64/Source/DynamicMemory.c
 * date              2018.12.04
 * last edit date    2018.12.04
 * author            NO.00[UNKNOWN]
 * brief             source code for dynamic memory
*/
...
/**
 *  function name : kInitializeDynamicMemory
 *  Parameters    : void
 *  return value  : void
...
/**
 *  function name : kCalculateDynamicMemorySize
 *  Parameters    : void
 *  return value  : QWORD
 *  brief         : calculate dynamic memory size
 */
...
/**
 *  function name : kCalculateMetaBlockCount
 *  Parameters    : qwDynamicRAMSize(QWORD)
 *  return value  : int
 *  brief         : calculate meta block for dynamic memory
 */
...
/**
 *  function name : kAllocateMemory
 *  Parameters    : qwSize(QWORD)
 *  return value  : void
...
/**
 *  function name : kGetBuddyBlockSize
 *  Parameters    : qwSize(QWORD)
 *  return value  : QWORD
 *  brief         : return buddy block size
 */
...
/**
 *  function name : kAllocationBuddyBlock
 *  Parameters    : qwAlignedSize(QWORD)
 *  return value  : int
 *  brief         : allocate buddy block
 */
...
/**
 *  function name : kGetBlockListIndexOfMatchSize
 *  Parameters    : qwAlignedSize(QWORD)
 *  return value  : int
 *  brief         : return matched index
 */
...
/**
 *  function name : kFindFreeBlockInBitmap
 *  Parameters    : iBlockListIndex(int)
 *  return value  : int
 *  brief         : find block list bitmap
 */
...
/**
 *  function name : kSetFlagInBitmap
 *  Parameters    : iBlockListIndex(int)
 *                  iOffset(int)
 *                  bFlag(BYTE)
 *  return value  : void
 *  brief         : set flag in bitmap
 */
...
/**
 *  function name : kFreeMemory
 *  Parameters    : pvAddress(void*)
 *  return value  : BOOL
...
/**
 *  function name : kFreeBuddyBlock
 *  Parameters    : iBlockListIndex(int)
 *                  iBlockOffset(int)
 *  return value  : BOOL
 *  brief         : free buddy block
 */
...
/**
 *  function name : kGetFlagInBitmap
 *  Parameters    : iBlockListIndex(int)
 *                  iOffset(int)
 *  return value  : BYTE
 *  brief         : get flag in bitmap
 */
...
/**
 *  function name : kGetDynamicMemoryInformation
 *  Parameters    : pqwDynamicMemoryStartAddress(QWORD*)
 *                  pqwDynamicMemoryTotalSize(QWORD*)
 *                  pqwMetaDataSize(QWORD*)
 *                  pqwUsedMemorySize(QWORD*)
 *  return value  : void
 *  brief         : get flag in bitmap
 */
...
/**
 *  function name : kGetDynamicMemoryManager
 *  Parameters    : void
 *  return value  : DYNAMICMEMORY*
 *  brief         : return struct managing dynamic memory
 */
